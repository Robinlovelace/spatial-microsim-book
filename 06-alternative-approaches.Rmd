...
We have different methods, each corresponing to a section : 
...
should be interpreted with a healthy dose of scepticism: just because an
...
algorithm in function of the `maxit` argument (Figure \ref{TimeOptim_GenSA}). This figure
...
but need to calculate the whole weight matrix in each iteration, where CO
