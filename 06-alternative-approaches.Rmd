...
```{r, fig.cap="Relationship between number of iterations and goodness-of-fit between observed and simulated results for different optimisation algorithms", fig.scap="Total Absolute Error in function of iteration for several algorithms", fig.width=4, fig.height=4, fig.align='center', echo=FALSE}
...
```{r, fig.cap="Relationship between processing time and goodness-of-fit between observed and simulated results for different optimisation algorithms",fig.scap="Total Absolute Error in function of processing time for several algorithms", fig.width=4, fig.height=4, fig.align='center', echo=FALSE}
