...
should the be the one that best fits the constraints. We could take
...
CO iss an alternative to IPF for allocating individuals
...
goodness-of-fit must be evaluated each time an individual is swapped.
