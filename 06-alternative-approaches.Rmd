...
will be needed to obtain a final individual level population. For example,
...
very effective when the objective function has several local minimums and
...
to perform a spatial microsimulation. We mentioned a regression
