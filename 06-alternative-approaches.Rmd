...
by Rahman (2009).  Tanton et al. (2011)
describe of the algorithm in full.
...
include only a part of the domain of the objective function. The constraints define the
...
\index{EU-SILC}
A new package for generating and modelling synthetic microdata is the R
package **simPop**, available on CRAN since August 2015.
The package contains example data from the 'EU-SILC'
database (EU statistics on income and living conditions), in addition
to datasets from the developing world.
