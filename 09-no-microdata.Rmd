...
represent the micro-level populations (Bierlaire, 1991).  \index{entropy maximisation}
...
The solution proposed by Barthélemy and Toint (2013), and used in this book,
is to generate a 'seed' before before the execution of IPF. 
