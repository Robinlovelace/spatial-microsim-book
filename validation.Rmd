...
model has worked and identifying *how good* the results are --- is vital in spatial microsimulation for
...
internal validation is the only available test of the model's output,
because of data for external validation is not available.
...
eaten) is deemed impossiblen in this case. (However, new sources of data such as
...
procedures, how to
identify outlying variables and zones which are simply not performing well and
