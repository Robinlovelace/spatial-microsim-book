...
each iteration in R:
**ipfp** and  **mipfp**. We will use each of these methods to generate the
same result: fractional weight matrices allocating each individual
to zones. After following this reweighting process we will progress to
integerisation: the process of converting 
...
and more a more generalized version of the IPF algorithm.
