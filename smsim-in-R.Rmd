...
Cross-tabulated constraints can be used in **mipfp**.
This means we can consider the zone as a variable, allowing
...
```{r}
mipfp_zones <- array(rep(weight_init, each = n_zone), dim = c(n_zone, 2, 2, 5))
