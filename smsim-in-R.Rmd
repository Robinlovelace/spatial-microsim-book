...
could correspond to these distributions. 
...
$$ABC(Male, Young, Academics)=\frac{AC(Male,Academics)}{\#Academics}BC(Young,Academics)$$

Suppose, we have 50 young academics out of 150 academics (90 female and 60 male). We would have:

$$ABC(Male, Young, Academics)=\frac{60}{150}*50=20$$
$$ABC(Female, Young, Academics)=\frac{90}{150}*50=30$$
