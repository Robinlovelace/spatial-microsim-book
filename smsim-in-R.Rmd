...
in the weight matrix. This simply consider the more probable configuration of 
individuals in these zones. It consists in calculating the maximum of *entropy*. 
The *entropy* is the number of physical configurations that result in this 
table of contingency. For more details about this theory, please refer to 
... []. In the subsequent examples, we use IPF to allocate individuals to zones 
in SimpleWorld, using the data loaded in the previous chapter as a basis. 
IPF is mature, fast and has a long history. Interested readers are directed towards recent papers 
(e.g. Lovelace and Ballas, 2012; Pritchard and Miller,2012) for more detail on the method.
