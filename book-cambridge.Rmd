...
interest (in that they match the constraint variables), the following command could be used to update the object,
...
```{r}
weights <- apply(cons, MARGIN=1, function(x) ipfp(x, ind_catt, x0, maxit = 20))
```
