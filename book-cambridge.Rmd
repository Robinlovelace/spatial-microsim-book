...
In pure R, seven characters are sufficient: `mean(x)`.
...
in the table below; the complete spatial microdataset allocates
...
This chapter also
provides the basis for the chapter in which we perform spatial microsimulation.
...
[github.com/Robinlovelace/spatial-microsim-book](https://github.com/Robinlovelace/spatial-microsim-book). From this page, click on the 'Download ZIP' button to the right of the page and extract the folder into a sensible place on your computer, such as the Desktop (unless you are confident 'forking' the project).
