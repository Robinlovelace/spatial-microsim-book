...
directory could be used to store experimental code). Because projects using spatial
microdata tend to be complex, imposing order over your workflow will yield dividends
in the long run: you reap what you sow!

In terms of writing R,
is helpful to remember that R can be seen as two separate components:
...
explaining ideas to other human beings
([Wickham, 2014](http://www.crcpress.com/product/isbn/9781466586963)).
Critical to its role as a
