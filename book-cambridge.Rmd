...
and this book teaches spatial microsimulation in the language of R.
Of course, English is more appropriate than R for *explaining* rather than
merely describing the method and the language of mathematics is appropriate
...
(see [Further R Resources](#further) in the Appendix). As
...
table at the end of [Chapter 4](#Smsim1).
...
Towards the end of [chapter 4](#Smsim1) we will learn how to generate
...
'[CakeMap.R](https://github.com/Robinlovelace/spatial-microsim-book/blob/master/CakeMap.R)'.
...
[infuse.mimas.ac.uk/](http://infuse.mimas.ac.uk/)](figures/raw-data-screenshot.jpeg)
...
[Lovelace, 2014](http://eprints.ncrm.ac.uk/3348/)) over 20
...
(Jones et al., [2014](http://www.crcpress.com/product/isbn/9781466569997)) is an
