...
in-line with its development at the Institute of Transport and Logistics Studies (ITLS), is especially
...
models can be used to allocate these synthetic households to geographic zones ([](#tresis-alloc)).
