...
names stand for 'Iterative Proportional Fitting', a term we will use frequently
...
(Horkik 2012). However, this problem is mitigated by the open-source
...
An recent development that has made R far more accessible is
