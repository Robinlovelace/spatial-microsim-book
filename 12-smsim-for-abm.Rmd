...
This chapter, contributed by Maja Založnik, is the most advanced chapter of the
book.^[Maja
is based at the Oxford Institute of Population Ageing in the University of Oxford.]
...
ABM models generally consist of interacting agents representing people and
...
R and NetLogo, allowing for model runs to be setup and run directly from within R
(Theile 2014). 
