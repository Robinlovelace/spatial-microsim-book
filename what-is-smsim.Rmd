...
Spatial microsimulation was used alongside 
hierarchical linear modelling, structural equation modelling and cluster analysis. Internet use was been hypothesised to 
...
Deetjen and Powell (forthecoming) is noteable for its use of
...
Interviews were used to further
