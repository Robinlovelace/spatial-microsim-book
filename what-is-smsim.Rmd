...
mis-interpretation of literature that employs the term.
...
### Spatial microsimultion as SimCity
...
([](#applications))
outlines some of the real-world problems spatial microsimulation has
...
"a methodology ...
to simulate the states and behaviors of different
...
the 'environment' is defined in predominently geographical terms: the
...
destpite not using the term 'spatial microsimulation',
...
highly non-linear and chaotic states (Batty 2005).
...
capabilities to such models is only set to grow (Wegener 2011).
