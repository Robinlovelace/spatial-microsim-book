...
microsimulation is a sub-part of ABM, as it creates a computational population, such
...
house. In ABM, when the researchers do not own sufficient data to perform their analyses,
