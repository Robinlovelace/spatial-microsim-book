...
Spatial microsimulation is a technique for generating individual-level data
allocated to geographical zones that is as similar as possible to
aggregate-level constraints. Its most common use in the social sciences is for allocating individuals from a survey dataset
