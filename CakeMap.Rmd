...
necessary for the **ipfp** package. To use **mipfp* the user must encode
the constraints in the right order and only the order.
...
of the individual data. It is important to check
...
two first constraints to be valid.
