...
weight_mipfp <- Ipfp( weight_init, descript, target, 
                      print = FALSE,tol=1e-5)
```

Remark that we don't print the `tol` in each iteration, because
200 iterations are necessary to reach convergence.


## Comparison of the two methods

mipfp allows to fast view the non represented categories into the individual data. Mipfp automatically check the consistency of the constraints and the names of the categories.
