...
-*Using the `mipfp` package* ([](#CakeMIPF)) also includes the whole
...
```{r, echo=FALSE, fig.cap="Scatter plot of the relationship between observed cell counts for all categories and all zones from the census (x axis) and the simulated cell counts after IPF (y axis) (ipfp vs mipfp).", fig.scap="Scatter plot of simulated and desired counts (ipfp vs mipfp)", fig.align='center'}
layout(matrix(c(1:3,3), 2, 2))
...
have better performances for problems of consequent sizes.
