...
```{r simpleworld GREGWT1,  fig.cap="The SimpleWorld example implemented with the R implementation of the GREGWT algorithm", echo=FALSE, message=FALSE, eval=FALSE}
...
```{r simpleworld GREGWT2,  fig.cap="The SimpleWorld example implemented with the R implementation of the GREGWT algorithm", echo=TRUE, message=FALSE, eval=FALSE}
