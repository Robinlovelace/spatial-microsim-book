...
- The first section asks 'what is spatial microsimulation and why use it?'
to provide a no-nonsense introduction to the field.
- The next section on terminology (\ref{terminology})
explains the spatial microsimulation nomenclature in more detail.
This involves an exploration of how spatial microsimulation
...
> A set of methods for the the creation, analysis and modelling of individual-level data allocated to geographical space.

Spatial microsimulation is therefore a *multi-level* approach.
It is well-suited to understanding complex phenomena which play-out over
