...
to avoid confusion.
For the purposes of this book we define spatial microsimulation as:
...
The rest of this chapter explains this succinct definition.
The purpose is to demystify
the various interpretations and uses of the approach in applied settings.
...
in transport modelling work is described by @Bathelemy2015a. This paper
...
@Bathelemy2015a are able to characterise a very large transport system
in great detail.
