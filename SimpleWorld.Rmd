...
aggregrate data presented above.
...
We will discover how the
weight matrices are generated in subsequent chapters.
For now it is sufficient to know
that weight matrices link individual-level data to geographically aggregated
data and that there are multiple techniques to generate them. The techniques are sometimes
referred to as *reweighting algorithms* in the literature (Tanton et al. 2011) and include deterministic methods such as Iterative Proportional
Fitting (IPF) and
