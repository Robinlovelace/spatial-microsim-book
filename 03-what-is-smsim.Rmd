...
```{r, fig.cap="Schematic of population synthesis, a critical element in spatial microsimulation", fig.scap="Schematic of population synthesis", fig.align='center', fig.pos='!h', echo=FALSE}
