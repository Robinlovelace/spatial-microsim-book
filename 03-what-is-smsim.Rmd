...
- *Terminology* (Section \ref{terminology}).
shows how spatial microsimulation
can be understood as either a method or an approach
([](#meth-approach)).
- *What spatial microsimulation is not* ([](#is-not)) describes how the approach
relates to other approaches such as ABM.
