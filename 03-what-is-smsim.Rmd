...
- *Terminology* (Section \ref{terminology}) explains the basis of the concept ([](#SimCity))
and shows how spatial microsimulation
can be understood as either a method or an approach
([](#meth-approach)).
- *What spatial microsimulation is not* ([](#is-not)) describes the differences between 
spatial microsimulation and other fields that could seem similar.
- *Applications* ([](#applications)) explores various academic and real-world
applications.
- *Assumptions* ([](#assumptions)) addresses
...
In this chapter, we have clearly defined what spatial microsimulation is
and what it is not. Then, we have mentioned some already developed applications.
Finally, we have quoted the underlying assumptions.
