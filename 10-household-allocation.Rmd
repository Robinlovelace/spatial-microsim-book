...
However, these data coming from another source, the marginals are incoherent 
...
the heads turn by turn. For each head, we
...
as good as the one showed above. However, in cases where 
...
was not sufficient. But, if you would like to fit age distributions, 
