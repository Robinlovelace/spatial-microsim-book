...
the proportion varies from 0.7\% to 1.05\%. These very little errors affect 
only a little proportion of each municipality 
and concern only the size of household (the type of household is always respected).

We can consider the synthetic population acceptable. Thanks to spatial microsimulation, these new synthetic data
