...
\hline
\end{tabular}
\caption{Example of an age distribution table with the proportions per women's age}
...
possible partners. Indeed, at the end of the process, only
a few partners remain to be assigned. Thus, 
...
worst municipality has only 0.5\% of non-assigned individuals. The majority 
