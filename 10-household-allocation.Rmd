...
When household-level constraints are
...
As illustrated
in figure 10.2, we individuals can be categorised first by
...
of the data and by the process of the IPF before the grouping. 


### With additional household's data

Without data on household structure, the only
...
To do this, tables of age differences and
age must be in the characteristics of the individuals.
