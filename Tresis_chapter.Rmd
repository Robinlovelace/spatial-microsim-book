...
# TODO explain what a discrete choice model
```
...
The methods and code blocks outlined below could therefore provide a stepping stone towards further transport modelling work in R, which is currently under-used in transport research. 
