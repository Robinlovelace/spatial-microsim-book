...
In summary, we have seen how to install RStudio and the basic use of this
tool. Then, we have fast developed all steps of a spatial microsimulation 
process for the little example *SimpleWorld*.
