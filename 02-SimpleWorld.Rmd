...
and potentially contribute to the book project, see
[@lima_coding_2014].
...
```{r studio,  fig.cap="The RStudio interface with the 'spatial-microsim-book' project loaded, with objects loaded in the Environment after running SimpleWorld.R",fig.scap="The RStudio interface", fig.align='center', echo=FALSE, message=FALSE}
# todo: create tutorial on installing R and RStudio
